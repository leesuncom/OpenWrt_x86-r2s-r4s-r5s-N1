...
curl -sfL https://github.com/sbwml/luci-app-mosdns/raw/v5/luci-app-mosdns/root/etc/hotplug.d/iface/99-mosdns -o openwrt-packages/luci-app-mosdns/root/etc/hotplug.d/iface/99-mosdns
